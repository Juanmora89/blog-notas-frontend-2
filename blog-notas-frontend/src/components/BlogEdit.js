...
const BlogEdit = () => {
  ...
  useEffect(() => {
    axios.get(`/api/blog-notas/${blogNotasId}`) // Adjust the route to match your API
      .then((response) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios.put(`/api/blog-notas/${blogNotasId}`, { title, artist, year, genre, condition })
      .then(() => {
